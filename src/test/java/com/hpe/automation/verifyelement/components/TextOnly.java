...
public class TextOnly extends CheckWebElementBase {
    ...
    public String checkTelHyperlink(WebElement element) {
        ...
        try {
            ...
            return TestBase.failedStepLog("- URL with phone number is not opened in a new window\n");
        } catch (Exception e) {
            return TestBase.failedStepLog("- something went wrong with tel on hyperlink\n");
        }
    }
