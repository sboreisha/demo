...
public class CheckVideoYoutube extends CheckWebElementBase implements CheckVideo {
    ...
    public String checkVideoAutoplay(WebElement element) {
        ...
        return TestBase.failedStepLog("- Yuotube video autoplay is not started\n");
    }
    ...
    public String checkPlayPauseButton(WebElement element) {
        ...
        if (!checkYoutubeVideoIsPlaying()) {
            ...
            return TestBase.failedStepLog("- youtube video is not started after pause\n");
        }
        return TestBase.failedStepLog("- youtube video is not paused on play button\n");
    }
    ...
    public String checkSpaceButton(WebElement element) {
        ...
        if (!checkYoutubeVideoIsPlaying()) {
            ...
            return TestBase.failedStepLog("- Video is not started after pause on Space\n");
        }
    ...
    public String checkMuteUnmute(WebElement element) {
        ...
        if (muteIsOn()) {
            ...
            return TestBase.failedStepLog("- Unmute is not working\n");
        }
        return TestBase.failedStepLog("- Mute is not working\n");
    }
    ...
    private void clickMuteButton() {
        ...
        try {
            ...
            TestBase.failedStepLog("- Mute button is not ok\n");
        }
    ...
    private Boolean muteIsOn() {
        try {
            ...
            TestBase.failedStepLog(" - Not able to find youtube volume slider\n");
            return false;
        }
    ...
    public String checkVideoCaption(WebElement element) {
        ...
        return TestBase.failedStepLog("- Video caption for Youtube is not working\n");
    }
    ...
    public String checkFullscreenVideo(WebElement element) {
        ...
        if (isFullscreenShownYoutube()) {
            ...
            return TestBase.failedStepLog("- Fullscreen is not closed on Esc button\n");
        }
        return TestBase.failedStepLog("- Fullscreen button os not working\n");
    }
    ...
    public String checkCloseVideoButton(WebElement element) {
        ...
        pressEsc();
        return TestBase.failedStepLog("- Video is not closed on Close button\n");
    }
    ...
    public String checkShareButton(WebElement element) {
        ...
        pressEsc();
        return TestBase.failedStepLog("- Share popup is not shown on hover\n");
    }
    ...
    public String checkPlayOnYoutube(WebElement element) {
        ...
        pressEsc();
        return TestBase.failedStepLog("- Youtube is not opened");
    }
